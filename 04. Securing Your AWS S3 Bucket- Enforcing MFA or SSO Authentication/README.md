...
If you are interested in finding out how to set your AWS account to allow accessing it using the AWS IAM Identity Center SSO instead of logging to the individual accounts in your AWS Organisation (which requires you to remember multiple users and passwords), please read my another article [Easier access to multiple accounts with IAM Identity Center](../02.%20Easier%20access%20to%20your%20accounts%20with%20IAM%20Identity%20Center/).
